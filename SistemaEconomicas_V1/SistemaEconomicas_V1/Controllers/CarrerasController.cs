...
namespace SistemaEconomicas_V1.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarreraId,CarreraNombre")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarreraId,CarreraNombre")] Carrera carrera)
        {
            if (ModelState.IsValid)
            {
